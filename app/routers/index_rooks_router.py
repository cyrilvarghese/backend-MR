...
class PDFProcessingRequest(BaseModel):
    pdf_file_path: str = os.path.expanduser("~/medical researcher/files/rooks 9th edition.pdf")  # Default file path
...
@router.get("/toc")
async def get_pdf_toc(pdf_file_path: str = os.path.expanduser("~/medical researcher/files/rooks 9th edition.pdf")):
    """
